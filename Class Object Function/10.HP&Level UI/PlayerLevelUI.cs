...
namespace TA
{
    public class PlayerLevelUI : MonoBehaviour
    {
        ...
        void Start()
        {
            ...
            leveltext.text = playerLevelController.currentExp.ToString();
        }
        ...
        private void UpdateLevelBarMonitor()
        {
            ...
            levelBarFill.fillAmount = (float)playerLevelController.currentExp / (float)playerLevelController.maxExp;
        }
    }
}
